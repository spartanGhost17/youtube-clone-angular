...
public class VideoQuery {
    ...
    public static final String INSERT_VIDEO_QUERY = "INSERT INTO Videos(user_id, title, duration, total_bytes, thumbnail_id, video_url, gif_url) VALUES (:userId, :title, :duration, :totalBytes, :thumbnailId, :videoUrl, :gifUrl)";
    ...
    public static final String SELECT_THUMBNAILS = "SELECT * FROM VideoThumbnails WHERE video_id = :videoId";
