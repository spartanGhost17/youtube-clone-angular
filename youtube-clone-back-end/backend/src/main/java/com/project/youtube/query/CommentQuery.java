...
public class CommentQuery {
    ...
    public static final String SELECT_SUB_COMMENT_PAGE_QUERY = "SELECT * FROM Comments WHERE video_id = :videoId AND parent_comment_id IS NOT NULL ORDER BY created_at DESC LIMIT :pageSize OFFSET :offset";
}
